/*
 * font5x7.h — Standard 5×7 pixel monospace font (public domain)
 *
 * Column-major format: 5 bytes per glyph, one byte per column.
 * Bit 0 = top row, bit 6 = bottom row, bit 7 unused.
 * Characters 0x20 (space) through 0x7F (mapped to ° degree symbol).
 */
#pragma once
